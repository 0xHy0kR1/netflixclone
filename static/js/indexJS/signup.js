...
var options = document.getElementById("options"); // Same as previous
var langList = document.getElementById("lang-list");

langSelect.onclick = function(){
    langList.classList.toggle("hide-lang-list"); // It will help us when we click on same language select box then it will hide and also show the hindi and english language
}
